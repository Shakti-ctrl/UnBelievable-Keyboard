package com.typing.master.pro.backup;

import android.content.Context;
import android.content.SharedPreferences;
import android.net.Uri;
import com.typing.master.pro.ClipboardHistoryService;
import com.typing.master.pro.Config;
    ...
    public static boolean restoreBackup(Context context, Uri uri) {
        try {
            ...
            if (backup.has("settings")) {
                ...
                editor.clear(); // Important: Wipe existing settings to match backup exactly
